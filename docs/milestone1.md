...
<img src="https://render.githubusercontent.com/render/math?math=\color{gray}\\begin{align*}J=\begin{bmatrix}\partialf_{1}/\partialx&amp;\partialf_{1}/\partialy\\\partialf_{2}/\partialx&amp;\partialf_{2}/\partialy\end{bmatrix}\end{align*}">
