...
<img src="https://render.githubusercontent.com/render/math?math=\\begin{align*}J=\begin{bmatrix}\partialf_{1}/\partialx&amp;\partial f_{1}/\partialy\\\partialf_{2}/\partialx&amp;\partialf_{2}/\partialy\end{bmatrix}\end{align*}">
