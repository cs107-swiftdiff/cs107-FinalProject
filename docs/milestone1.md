...
<img src="https://render.githubusercontent.com/render/math?math=\color{gray}\\begin{align*}J=\begin{bmatrix}\partial f_{1}/\partial x;\partial f_{1}/\partial y\\\partial f_{2}/\partial x;\partial f_{2}/\partial y\end{bmatrix}\end{align*}">
